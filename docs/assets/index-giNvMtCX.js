...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Nc(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ya(),fragmentShader:`
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Fc(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ya(),fragmentShader:`
...
#define LOW_PRECISION`),t}function um(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===No?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===fu?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===an&&(t="SHADOWMAP_TYPE_VSM"),t}function hm(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ii:case ri:t="ENVMAP_TYPE_CUBE";break;case fr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function dm(i){let t="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===ri&&(t="ENVMAP_MODE_REFRACTION"),t}function fm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Bo:t="ENVMAP_BLENDING_MULTIPLY";break;case Du:t="ENVMAP_BLENDING_MIX";break;case Iu:t="ENVMAP_BLENDING_ADD";break}return t}function pm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function mm(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=um(e),l=hm(e),u=dm(e),d=fm(e),h=pm(e),m=nm(e),g=im(s),M=r.createProgram();let p,f,b=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Zi).join(`
`)),a=Ka(a),a=Jc(a,e),a=jc(a,e),o=Ka(o),o=Jc(o,e),o=jc(o,e),a=Qc(a),o=Qc(o),e.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
Can you save her?`]},hud:{appName:"Tablet",velocity:"VEL",orientation:"ORI",fps:"FPS",dampingOn:"damping: ON",dampingOff:"damping: OFF",fastTravelButton:"FAST TRAVEL",fastTravelHint:"R1 / F",fastTravelActive:"warping…",rovers:"ROVERS",credits:"CRED",hackHint:"Hold L1 / H to hack",upgradeButton:"UPGRADES",upgradeHint:"Y / U",upgradeBought:"OWNED",upgradeBuy:"BUY",missionCompleteTitle:"MISSION COMPLETE",missionCompleteBody:"All rovers repaired. Earth Command transfers a bonus to your account.",missionCompleteCta:"Open Upgrades",missionCompleteClose:"Continue Flying",resetHint:"Start / R = reset",tabletHint:"− / T = Tablet"}};function C_(){const i=document.createElement("div");i.id="tablet",i.innerHTML=`
  ...
  `,document.body.appendChild(i);const t=document.createElement("div");t.id="tablet-hint",t.textContent=jt.hud.tabletHint,t.hidden=!0,document.body.appendChild(t);const e=i.querySelector("[data-velocity]"),n=i.querySelector("[data-orientation]"),r=i.querySelector("[data-fps]"),s=i.querySelector("[data-source]"),a=i.querySelector("[data-damping]"),o=i.querySelector("[data-fast-travel]"),c=i.querySelector("[data-upgrades]");i.style.display="none";const l=i.querySelector("[data-reset-hint]"),u=i.querySelector("[data-mission]"),d=i.querySelector("[data-rovers]"),h=i.querySelector("[data-credits]"),m=i.querySelector("[data-hack]"),g=i.querySelector("[data-hack-name]"),M=i.querySelector("[data-hack-fill]");let p=0,f=0,b=0;return{update({velocity:v,eulerDeg:S,dt:P,sources:R,dampingOn:w}){e.textContent=v.toFixed(1),n.textContent=`${S.x.toFixed(0)}°, ${S.y.toFixed(0)}°, ${S.z.toFixed(0)}°`,p+=1,f+=P,f>=.5&&(b=Math.round(p/f),p=0,f=0,r.textContent=String(b)),s.textContent=R.join("+"),a.textContent=w?jt.hud.dampingOn:jt.hud.dampingOff},show(){i.style.display="",t.hidden=!0},hide(){i.style.display="none",t.hidden=!1},toggle(){const v=i.style.display==="none";return i.style.display=v?"":"none",t.hidden=v,v},setHintVisible(v){t.hidden=!v},showFastTravel(){o.classList.add("tablet-app-btn--visible")},showUpgrades(){c.classList.add("tablet-app-btn--visible")},showResetHint(){l.hidden=!1},setMissionVisible(v){u.hidden=!v},updateMission({remaining:v,total:S,credits:P}){d.textContent=`${S-v}/${S}`,h.textContent=String(P)},updateHack({name:v,progress:S}){if(!v){m.hidden=!0;return}m.hidden=!1,g.textContent=v,M.style.width=`${Math.max(0,Math.min(1,S))*100}%`},onUpgradesClick(v){c.addEventListener("click",v)},setFastTravelActive(v){o.classList.toggle("tablet-app-btn--active",v);const S=o.querySelector(".tablet-app-btn__label");S.textContent=v?jt.hud.fastTravelActive:jt.hud.fastTravelButton,o.disabled=v},onFastTravel(v){o.addEventListener("click",v)}}}function P_(){const i=document.createElement("div");return i.id="title-card",i.innerHTML=`
    <div class="title-card__inner">
      <h1 class="title-card__title">${jt.title}</h1>
      <p class="title-card__prompt">${jt.pressAnyKey}</p>
    </div>
  `,document.body.appendChild(i),{hide(){i.style.opacity="0"},show(){i.style.opacity=""},dismiss(){i.classList.add("title-card--hidden"),setTimeout(()=>i.remove(),500)}}}const L_=1.2,Wl=540;function D_(i){const t=document.createElement("div");t.id="warp-flash",i.appendChild(t);let e=!1,n=0,r=!1,s=null,a=!1,o=null;function c(u,d={}){return e?!1:(e=!0,n=0,r=!1,s=d.onDone??null,a=!0,o=u,u.velocity.set(0,0,0),!0)}function l(u){if(!e)return;n+=u;const h=Math.max(0,Math.min(1,n/L_));let m;if(h<.4?m=h/.4:h<.6?m=1:m=1-(h-.6)/.4,t.style.opacity=String(Math.max(0,Math.min(1,m))),!r&&h>=.5&&o&&(o.mesh.position.set(0,0,Wl),o.velocity.set(0,0,0),o.mesh.quaternion.identity(),r=!0),h>=1){e=!1,a=!1,t.style.opacity="0";const g=s;s=null,o=null,g&&g()}}return{begin:c,update:l,get active(){return e},get suppressInput(){return a},targetZ:Wl}}const Xl=80,I_=18,U_=.06,N_=2.5,ql=280,F_=520,O_=.18,B_=.18;function z_(){let i=null,t=!1,e=null,n=null,r=null,s=0;function a(){if(t)return!0;const h=window.AudioContext||window.webkitAudioContext;return h?(i=new h,e=i.createGain(),e.gain.value=1,e.connect(i.destination),n=H_(i,e),r=G_(i,e),t=!0,!0):!1}function o(h){t&&(s=Math.min(1,Math.abs(h)))}function c(h){if(!t)return;const m=1-Math.pow(2,-h/B_),g=r.gainNode.gain.value,M=s*O_,p=g+(M-g)*m;r.gainNode.gain.setValueAtTime(p,i.currentTime);const f=ql+s*F_;r.filter.frequency.setValueAtTime(f,i.currentTime)}function l(){if(t){try{n.osc1.stop(),n.osc2.stop()}catch{}try{r.source.stop()}catch{}i.close(),t=!1,i=null}}function u({fromHz:h=300,toHz:m=900,durationS:g=.35,peakGain:M=.18}={}){if(!t)return;const p=i.currentTime,f=i.createOscillator();f.type="sine",f.frequency.setValueAtTime(h,p),f.frequency.exponentialRampToValueAtTime(m,p+g);const b=i.createGain();b.gain.setValueAtTime(0,p),b.gain.linearRampToValueAtTime(M,p+.03),b.gain.exponentialRampToValueAtTime(1e-4,p+g),f.connect(b),b.connect(e),f.start(p),f.stop(p+g+.05)}function d(){u({fromHz:440,toHz:660,durationS:.45,peakGain:.2}),setTimeout(()=>u({fromHz:660,toHz:990,durationS:.6,peakGain:.22}),200)}return{start:a,update:c,setThrottle:o,chirp:u,fanfare:d,dispose:l,get running(){return t}}}function H_(i,t){const e=i.createOscillator(),n=i.createOscillator();e.type="triangle",n.type="triangle",e.frequency.value=Xl,n.detune.value=I_,n.frequency.value=Xl;const r=i.createBiquadFilter();r.type="lowpass",r.frequency.value=320,r.Q.value=.7;const s=i.createGain();return s.gain.value=U_,e.connect(r),n.connect(r),r.connect(s),s.connect(t),e.start(),n.start(),{osc1:e,osc2:n,filter:r,gain:s}}function G_(i,t){const e=i.sampleRate,n=i.createBuffer(1,e*N_,e),r=n.getChannelData(0);for(let c=0;c<r.length;c++)r[c]=Math.random()*2-1;const s=i.createBufferSource();s.buffer=n,s.loop=!0;const a=i.createBiquadFilter();a.type="bandpass",a.frequency.value=ql,a.Q.value=1.2;const o=i.createGain();return o.gain.value=0,s.connect(a),a.connect(o),o.connect(t),s.start(),{source:s,filter:a,gainNode:o}}const k_=8,V_=2,W_=100,ps={ACTIVE:"active",COMPLETE:"complete"};function X_(i){const{rovers:t,markFixed:e}=i;let n=0,r=ps.ACTIVE,s=null,a=null,o=null,c=null;function l(f){o=f}function u(f){c=f}function d(){let f=0;for(const b of t)b.fixed||(f+=1);return f}function h(){return t.length}function m(f,b){if(b>k_)return null;let v=null,S=Se.hackRadius*Se.hackRadius;for(const P of t){if(P.fixed)continue;const R=P.position.x-f.x,w=P.position.y-f.y,L=P.position.z-f.z,k=R*R+w*w+L*L;k<S&&(S=k,v=P)}return v}function g({shipPos:f,shipSpeed:b,holdActive:v,dt:S}){if(s=m(f,b),r!==ps.ACTIVE){a=null;return}if(v&&s){if(a!==s&&(a=s,a.repairProgress=0),a.repairProgress=Math.min(1,a.repairProgress+S/V_),a.repairProgress>=1&&!a.fixed){const P=a;e(P),n+=P.creditValue,c&&c(P),a=null,d()===0&&(r=ps.COMPLETE,n+=W_,o&&o())}}else a&&(a.repairProgress=0,a=null)}function M(f){return f>n?!1:(n-=f,!0)}function p(){n=0,r=ps.ACTIVE,s=null,a=null}return{get state(){return r},get credits(){return n},get inRange(){return s},get repairing(){return a},remaining:d,totalRovers:h,update:g,spendCredits:M,setOnComplete:l,setOnRepaired:u,reset:p}}function q_(){const i=[{id:"throttle",label:"Boost Throttle",description:"Push the engines harder. +40% forward acceleration, +25% top speed.",cost:100,bought:!1,apply(){Se.maxThrottleAccel*=1.4,Se.maxSpeed*=1.25}},{id:"agility",label:"Sharper Turning",description:"Twitch-faster yaw and pitch. +35% on both rates.",cost:90,bought:!1,apply(){Se.yawRate*=1.35,Se.pitchRate*=1.35}},{id:"hackRange",label:"Long-Range Hack",description:"The Tablet locks on from further out. Hack radius +50%.",cost:80,bought:!1,apply(){Se.hackRadius*=1.5}}];function t(n,r){const s=i.find(a=>a.id===n);return!s||s.bought||!r.spendCredits(s.cost)?!1:(s.apply(),s.bought=!0,!0)}function e(){for(const n of i)n.bought=!1}return{upgrades:i,buy:t,reset:e}}function Y_({upgrades:i,mission:t,audio:e}){const n=document.createElement("div");n.id="mission-screens",n.innerHTML=`
  ...
  `,document.body.appendChild(n);const r=n.querySelector("#screen-complete"),s=n.querySelector("[data-complete-credits]"),a=n.querySelector("#screen-upgrades"),o=n.querySelector("[data-upgrades-credits]"),c=n.querySelector("[data-upgrade-list]");function l(){o.textContent=String(t.credits),c.innerHTML="";for(const g of i.upgrades){const M=document.createElement("li");M.className="upgrade-item"+(g.bought?" upgrade-item--bought":"");const p=!g.bought&&t.credits>=g.cost;M.innerHTML=`
      ...
      `,c.appendChild(M)}}function u(g){g==="complete"?(s.textContent=String(t.credits),r.hidden=!1):g==="upgrades"&&(l(),a.hidden=!1)}function d(g){g==="complete"?r.hidden=!0:g==="upgrades"&&(a.hidden=!0)}function h(){d("complete"),d("upgrades")}function m(){return!r.hidden||!a.hidden}return n.addEventListener("click",g=>{const M=g.target;if(!(M instanceof Element))return;const p=M.getAttribute("data-action");if(p==="open-upgrades"){d("complete"),u("upgrades");return}if(p==="close-complete"){d("complete");return}if(p==="close-upgrades"){d("upgrades");return}const f=M.getAttribute("data-buy");f&&i.buy(f,t)&&(e&&e.chirp({fromHz:520,toHz:780,durationS:.25,peakGain:.18}),l())}),{show:u,hide:d,hideAll:h,isOpen:m}}const Yl=40;function $_(){const e=document.createElement("canvas");e.width=1024,e.height=512;const n=e.getContext("2d"),r=n.createLinearGradient(0,0,0,512);r.addColorStop(0,"#0c3a66"),r.addColorStop(.5,"#1b6aa3"),r.addColorStop(1,"#0c3a66"),n.fillStyle=r,n.fillRect(0,0,1024,512);const s=[];for(let o=0;o<6;o++)s.push({x:Math.random()*1024,y:512*.25+Math.random()*512*.5,r:50+Math.random()*90});for(const o of s){const c=8+Math.floor(Math.random()*6);for(let l=0;l<c;l++){const u=(Math.random()-.5)*o.r*1.6,d=(Math.random()-.5)*o.r*1,h=18+Math.random()*45,m=Math.random()<.35;n.beginPath(),n.fillStyle=m?"rgba(30, 70, 30, 0.85)":"rgba(70, 130, 55, 0.9)",n.arc(o.x+u,o.y+d,h,0,Math.PI*2),n.fill()}}for(let o=0;o<60;o++){const c=Math.random()*1024,l=Math.random()*512,u=14+Math.random()*50;n.beginPath(),n.fillStyle=`rgba(245, 250, 255, ${.1+Math.random()*.12})`,n.arc(c,l,u,0,Math.PI*2),n.fill()}for(const o of[0,512]){const c=n.createRadialGradient(512,o,0,512,o,153.6);c.addColorStop(0,"rgba(240, 248, 255, 0.85)"),c.addColorStop(1,"rgba(240, 248, 255, 0)"),n.fillStyle=c,n.fillRect(0,0,1024,512)}const a=new is(e);return a.colorSpace=Ce,a}function K_(){const i=new Jn(Yl,64,32),t=new Pe({map:$_(),roughness:.85,metalness:0,emissive:1296}),e=new Gt(i,t),n=new Si({color:6990591,transparent:!0,opacity:.18,blending:_n,side:ye}),r=new Gt(new Jn(Yl*1.05,64,32),n);e.add(r);const s=.05;function a(o){e.rotation.y+=s*o}return{mesh:e,update:a}}const $l=14,Kl=4.5,Z_=.9;function J_(){const i=new $n,t=new ho(1,0);t.scale(Kl,Kl,$l*.5);const e=new Pe({color:3807780,roughness:.45,metalness:.6,emissive:3149848,flatShading:!0}),n=new Gt(t,e);i.add(n);const r=new Si({color:16724016}),s=new Gt(new Jn(Z_,12,8),r);s.position.set(0,0,$l*.55),i.add(s);const a=document.createElement("canvas");a.width=a.height=128;{const d=a.getContext("2d"),h=64,m=d.createRadialGradient(h,h,0,h,h,h);m.addColorStop(0,"rgba(255, 60, 60, 1)"),m.addColorStop(.3,"rgba(255, 30, 30, 0.6)"),m.addColorStop(1,"rgba(255, 30, 30, 0)"),d.fillStyle=m,d.fillRect(0,0,128,128)}const o=new is(a);o.colorSpace=Ce;const c=new ll(new Ja({map:o,transparent:!0,blending:_n,depthWrite:!1}));c.position.copy(s.position),c.scale.setScalar(5.5),i.add(c);const l=new Te(.35,1.4,6);l.translate(0,0,-1.5);const u=new Pe({color:1837586,roughness:.6,metalness:.5,emissive:2099216,flatShading:!0});for(const d of[-1,1]){const h=new Gt(l,u);h.position.set(d*2.6,0,-2.5),h.rotation.z=d*.25,h.rotation.y=d*.2,i.add(h)}return{group:i,hull:n,core:s,halo:c}}const ms=i=>i*i*(3-2*i),j_=i=>i<.5?4*i*i*i:1-Math.pow(-2*i+2,3)/2,yo=[3.5,3,4,4,3.5,4.5];function Q_({renderer:i}){const t=new sl;t.background=new zt(66055);const e=new Fe(50,window.innerWidth/window.innerHeight,.1,5e3);e.position.set(0,8,140),e.lookAt(0,0,0),t.add(new Cl(10141920,1052704,.7));const n=new Dl(16773848,1.1);n.position.set(50,30,80),t.add(n);const r=Fl();t.add(r);const s=K_();t.add(s.mesh);const a=J_();a.group.position.set(200,30,30),a.group.rotation.y=-.6,t.add(a.group);const o=new Si({color:16732224,transparent:!0,opacity:0,blending:_n,depthWrite:!1,side:Je}),c=new Gt(new Ui(2,60,16,1,!0),o);c.rotation.x=Math.PI,t.add(c);const l=document.createElement("div");l.id="cinematic",l.innerHTML=`
  ...
  `,document.body.appendChild(l);const u=l.querySelector("[data-text]"),d=l.querySelector("[data-flash]");let h=0,m=0,g=0,M=!0,p=!0;function f(k,_,y){switch(k){case 0:{s.mesh.position.set(0,0,0),s.mesh.scale.setScalar(1+.02*Math.sin(g*.5)),a.group.position.x=200,c.material.opacity=0;break}case 1:{s.mesh.position.set(0,0,0),e.position.x=-10+20*j_(_),e.lookAt(0,0,0);break}case 2:{const O=140+-45*ms(_);e.position.set(0,8,O),e.lookAt(0,0,0);const F=140,G=38;a.group.position.x=F+(G-F)*ms(_),a.group.position.z=30-10*ms(_),a.group.rotation.y=-.6-.4*ms(_);break}case 3:{e.position.set(0,8,95),a.group.position.x=38,a.group.position.z=20,a.group.rotation.y=-1,c.material.opacity=.4+.35*Math.sin(g*12);const O=a.group.position,F=s.mesh.position;c.position.set((O.x+F.x)/2,(O.y+F.y)/2,(O.z+F.z)/2),c.lookAt(F),c.rotateX(Math.PI/2),e.position.x=Math.sin(g*30)*.4,e.position.y=8+Math.cos(g*27)*.3,e.position.z=95,e.lookAt(0,0,0);break}case 4:{a.group.position.x=38,a.group.position.z=20,e.position.set(0,8,95),e.lookAt(0,0,0),_<.5?(d.style.opacity=String(_*2*.95),c.material.opacity=.35*(1-_*2)):(a.group.visible=!1,s.mesh.visible=!1,c.material.opacity=0,d.style.opacity=String(Math.max(0,1-(_-.5)*2)));break}case 5:{d.style.opacity="0";break}}}function b(k){u.innerHTML=k.split(`
`).map(_=>`<p>${_}</p>`).join(""),u.classList.remove("cinematic__text--in"),u.offsetWidth,u.classList.add("cinematic__text--in")}function v(){h+=1,m=0,p=!0,h>=yo.length&&S()}function S(){M&&(M=!1,l.remove(),t.traverse(k=>{k.geometry&&k.geometry.dispose();const _=Array.isArray(k.material)?k.material:k.material?[k.material]:[];for(const y of _)y.map&&y.map.dispose(),y.dispose()}))}function P(){S()}function R(k){if(!M)return;g+=k,m+=k,p&&(b(jt.intro.beats[h]),p=!1);const _=Math.min(1,m/yo[h]);f(h,_),s.update(k),a.halo.material.opacity=.7+.25*Math.sin(g*4),Ol(r,e),m>=yo[h]&&v()}function w(){M&&i.render(t,e)}function L(){e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix()}return{update:R,render:w,skip:P,onResize:L,get active(){return M}}}function t0(){if(!(new URLSearchParams(window.location.search).get("debugPad")==="1"))return{update(){}};const t=document.createElement("div");t.id="debug-pad",Object.assign(t.style,{position:"fixed",top:"8px",left:"8px",zIndex:"9999",background:"rgba(0,0,0,0.78)",color:"#9af0a0",font:"11px ui-monospace, Menlo, Consolas, monospace",padding:"8px 10px",maxWidth:"min(92vw, 520px)",maxHeight:"60vh",overflow:"auto",border:"1px solid #3a3",borderRadius:"4px",whiteSpace:"pre-wrap",pointerEvents:"none",lineHeight:"1.35"}),document.body.appendChild(t);function e(){const n=Vl(),r=n?window.__p5NativeHost===!0?"__p5NativeHost=true":"webkit.messageHandlers":"(none — desktop / non-wrapper)",s=window.__nativeGamepadBridgeReady===!0,a=window.__nativeGamepadUpdateCount||0,o=window.__nativeGamepadLastRaw,c=typeof navigator.getGamepads=="function"?navigator.getGamepads():[],l=c&&c[0];let u="(no pad)";if(l){const d=[];for(let h=0;h<l.buttons.length;h++)l.buttons[h]&&l.buttons[h].pressed&&d.push(h);u=`id=${JSON.stringify(l.id)}
mapping=${l.mapping}
...
`)}return{update(){t.textContent=e()}}}const{resolveAsteroidCollisions:e0}=x_,n0=document.getElementById("app"),Oi=new $m({antialias:!0});Oi.setPixelRatio(Math.min(window.devicePixelRatio,2)),Oi.setSize(window.innerWidth,window.innerHeight),n0.appendChild(Oi.domElement);const Pn=Fg(),nn=Og(),ie=Wg(),Zl=Fl(),Eo=jg(),Jl=t_(),jl=r_(),gs=p_(),bo=__();Pn.add(ie.mesh),Pn.add(Zl),Pn.add(Eo.mesh),Pn.add(Jl.mesh),Pn.add(jl.sprite);for(const i of gs.rovers)Pn.add(i.mesh);Pn.add(bo.points),ie.mesh.visible=!0;const fe=R_(),Le=C_(),To=P_(),dr=D_(document.body),Qn=z_(),Ql=q_(),rn=X_(gs),sn=Y_({upgrades:Ql,mission:rn,audio:Qn});rn.setOnRepaired(i=>{bo.fire(i.mesh.position),Qn.chirp()}),rn.setOnComplete(()=>{Qn.fanfare(),sn.show("complete")}),Le.onFastTravel(()=>{tu()}),Le.onUpgradesClick(()=>{sn.show("upgrades")});function i0(){ie.mesh.position.set(0,0,0),ie.velocity.set(0,0,0),ie.mesh.quaternion.identity(),ie.arcadeDamping=!1,rn.reset(),gs.reset(),Ql.reset(),Bg(),sn.hideAll()}function tu(){dr.active||(Le.setFastTravelActive(!0),dr.begin(ie,{onDone:()=>Le.setFastTravelActive(!1)}))}const r0=new C(0,1.4,-5.5),s0=new C(0,0,4),a0=.04,o0=.03,Ao=new C,wo=new C,_s=new C;let eu=!1;function c0(i){if(Ao.copy(r0).applyQuaternion(ie.mesh.quaternion).add(ie.mesh.position),wo.copy(s0).applyQuaternion(ie.mesh.quaternion).add(ie.mesh.position),!eu)nn.position.copy(Ao),_s.copy(wo),eu=!0;else{const e=1-Math.pow(2,-i/a0),n=1-Math.pow(2,-i/o0);nn.position.lerp(Ao,e),_s.lerp(wo,n)}nn.lookAt(_s);const t=new C(0,1,0).applyQuaternion(ie.mesh.quaternion);nn.up.copy(t),nn.lookAt(_s)}function l0(){const i=window.innerWidth,t=window.innerHeight;nn.aspect=i/t,nn.updateProjectionMatrix(),Oi.setSize(i,t),Ln&&Ln.onResize()}window.addEventListener("resize",l0);const Bi={CINEMATIC:"cinematic",TITLE:"title",FLY:"fly"},Ln=new URLSearchParams(window.location.search).get("skipIntro")==="1"?null:Q_({renderer:Oi});let vs=Ln?Bi.CINEMATIC:Bi.TITLE;Ln&&To.hide();const u0=t0();function h0(){vs=Bi.TITLE,To.show(),Le.show()}let nu=performance.now();const xs=new ze;function Ro(i){const t=(i-nu)/1e3,e=Math.min(t,.1);if(nu=i,u0.update(),vs===Bi.CINEMATIC){fe.consumeAnyJustPressed()&&(Ln.skip(),fe.gamepad.suppressCurrentlyPressed()),Ln.update(e),Ln.render(),Ln.active||h0(),requestAnimationFrame(Ro);return}if(vs===Bi.TITLE)fe.consumeAnyJustPressed()&&(vs=Bi.FLY,To.dismiss(),Le.showFastTravel(),Le.showUpgrades(),Le.setMissionVisible(!0),Le.showResetHint(),Le.hide(),fe.enableGyro().catch(()=>{}),Qn.start());else{if((fe.keyboard.consumeJustPressed(["KeyT"])||fe.gamepad.consumeJustPressed(jn.Select))&&Le.toggle(),(fe.keyboard.consumeJustPressed(["KeyX"])||fe.gamepad.consumeJustPressed(jn.X))&&(ie.arcadeDamping=!ie.arcadeDamping),(fe.keyboard.consumeJustPressed(["KeyF"])||fe.gamepad.consumeJustPressed(jn.R1))&&tu(),(fe.keyboard.consumeJustPressed(["KeyU"])||fe.gamepad.consumeJustPressed(jn.Y))&&(sn.isOpen()?sn.hideAll():sn.show("upgrades")),fe.gamepad.consumeJustPressed(jn.B)&&sn.isOpen()&&sn.hideAll(),(fe.keyboard.consumeJustPressed(["KeyR"])||fe.gamepad.consumeJustPressed(jn.Start))&&i0(),dr.suppressInput||sn.isOpen())Qn.setThrottle(0);else{const s=fe.sample();qg(ie,s,e),Qn.setThrottle(s.throttle),e0({position:ie.mesh.position,velocity:ie.velocity},Eo.instances),ie.braking&&ie.velocity.set(0,0,0)}const r=fe.keyboard.isDown("KeyH")||fe.gamepad.isButtonDown(jn.L1);rn.update({shipPos:ie.mesh.position,shipSpeed:ie.velocity.length(),holdActive:r&&!sn.isOpen()&&!dr.suppressInput,dt:e})}dr.update(e),Qn.update(e),Eo.update(e),Jl.update(e),jl.update(nn),gs.update(e),bo.update(e),Ol(Zl,nn),c0(e),Oi.render(Pn,nn),xs.setFromQuaternion(ie.mesh.quaternion,"YXZ"),Le.update({velocity:ie.velocity.length(),eulerDeg:{x:xa.radToDeg(xs.x),y:xa.radToDeg(xs.y),z:xa.radToDeg(xs.z)},dt:e,sources:fe.activeSources(),dampingOn:ie.arcadeDamping}),Le.updateMission({remaining:rn.remaining(),total:rn.totalRovers(),credits:rn.credits});const n=rn.repairing??rn.inRange;Le.updateHack({name:n?n.name:null,progress:n?n.repairProgress:0}),requestAnimationFrame(Ro)}requestAnimationFrame(Ro)})();
