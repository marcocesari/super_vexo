...
`)+`
`+p);const x=y+m+o,M=y+p+a,I=ih(s,s.VERTEX_SHADER,x),b=ih(s,s.FRAGMENT_SHADER,M);s.attachShader(_,I),s.attachShader(_,b),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function A(w){if(i.debug.checkShaderErrors){const z=s.getProgramInfoLog(_).trim(),L=s.getShaderInfoLog(I).trim(),V=s.getShaderInfoLog(b).trim();let te=!0,B=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(te=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,I,b);else{const $=sh(s,I,"vertex"),Y=sh(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
}`;function qg(i,e,t){let n=new xc;const s=new ue,r=new ue,o=new Ze,a=new Gg({depthPacking:ip}),c=new Vg,l={},u=t.maxTextureSize,h={[Pn]:Lt,[Lt]:Pn,[wt]:wt},d=new ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ue},radius:{value:4}},vertexShader:Wg,fragmentShader:Xg}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new ft;g.setAttribute("position",new Tt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new ie(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Vl;let p=this.type;this.render=function(b,A,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const N=i.getRenderTarget(),v=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),z=i.state;z.setBlending(Xn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const L=p!==Cn&&this.type===Cn,V=p===Cn&&this.type!==Cn;for(let te=0,B=b.length;te<B;te++){const $=b[te],Y=$.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;s.copy(Y.mapSize);const pe=Y.getFrameExtents();if(s.multiply(pe),r.copy(Y.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/pe.x),s.x=r.x*pe.x,Y.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/pe.y),s.y=r.y*pe.y,Y.mapSize.y=r.y)),Y.map===null||L===!0||V===!0){const F=this.type!==Cn?{minFilter:Gt,magFilter:Gt}:{};Y.map!==null&&Y.map.dispose(),Y.map=new gi(s.x,s.y,F),Y.map.texture.name=$.name+".shadowMap",Y.camera.updateProjectionMatrix()}i.setRenderTarget(Y.map),i.clear();const ve=Y.getViewportCount();for(let F=0;F<ve;F++){const he=Y.getViewport(F);o.set(r.x*he.x,r.y*he.y,r.x*he.z,r.y*he.w),z.viewport(o),Y.updateMatrices($,F),n=Y.getFrustum(),M(A,C,Y.camera,$,this.type)}Y.isPointLightShadow!==!0&&this.type===Cn&&y(Y,C),Y.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(N,v,w)};function y(b,A){const C=e.update(_);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,f.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new gi(s.x,s.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(A,null,C,d,_,null),f.uniforms.shadow_pass.value=b.mapPass.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(A,null,C,f,_,null)}function x(b,A,C,N){let v=null;const w=C.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(w!==void 0)v=w;else if(v=C.isPointLight===!0?c:a,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const z=v.uuid,L=A.uuid;let V=l[z];V===void 0&&(V={},l[z]=V);let te=V[L];te===void 0&&(te=v.clone(),V[L]=te,A.addEventListener("dispose",I)),v=te}if(v.visible=A.visible,v.wireframe=A.wireframe,N===Cn?v.side=A.shadowSide!==null?A.shadowSide:A.side:v.side=A.shadowSide!==null?A.shadowSide:h[A.side],v.alphaMap=A.alphaMap,v.alphaTest=A.alphaTest,v.map=A.map,v.clipShadows=A.clipShadows,v.clippingPlanes=A.clippingPlanes,v.clipIntersection=A.clipIntersection,v.displacementMap=A.displacementMap,v.displacementScale=A.displacementScale,v.displacementBias=A.displacementBias,v.wireframeLinewidth=A.wireframeLinewidth,v.linewidth=A.linewidth,C.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const z=i.properties.get(v);z.light=C}return v}function M(b,A,C,N,v){if(b.visible===!1)return;if(b.layers.test(A.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&v===Cn)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,b.matrixWorld);const L=e.update(b),V=b.material;if(Array.isArray(V)){const te=L.groups;for(let B=0,$=te.length;B<$;B++){const Y=te[B],pe=V[Y.materialIndex];if(pe&&pe.visible){const ve=x(b,pe,N,v);b.onBeforeShadow(i,b,A,C,L,ve,Y),i.renderBufferDirect(C,null,L,ve,b,Y),b.onAfterShadow(i,b,A,C,L,ve,Y)}}}else if(V.visible){const te=x(b,V,N,v);b.onBeforeShadow(i,b,A,C,L,te,null),i.renderBufferDirect(C,null,L,te,b,null),b.onAfterShadow(i,b,A,C,L,te,null)}}const z=b.children;for(let L=0,V=z.length;L<V;L++)M(z[L],A,C,N,v)}function I(b){b.target.removeEventListener("dispose",I);for(const C in l){const N=l[C],v=b.target.uuid;v in N&&(N[v].dispose(),delete N[v])}}}const Yg={[ta]:na,[ia]:oa,[sa]:aa,[Oi]:ra,[na]:ta,[oa]:ia,[aa]:sa,[ra]:Oi};function Kg(i){function e(){let D=!1;const Ae=new Ze;let Z=null;const oe=new Ze(0,0,0,0);return{setMask:function(Ee){Z!==Ee&&!D&&(i.colorMask(Ee,Ee,Ee,Ee),Z=Ee)},setLocked:function(Ee){D=Ee},setClear:function(Ee,Re,$e,St,qt){qt===!0&&(Ee*=St,Re*=St,$e*=St),Ae.set(Ee,Re,$e,St),oe.equals(Ae)===!1&&(i.clearColor(Ee,Re,$e,St),oe.copy(Ae))},reset:function(){D=!1,Z=null,oe.set(-1,0,0,0)}}}function t(){let D=!1,Ae=!1,Z=null,oe=null,Ee=null;return{setReversed:function(Re){Ae=Re},setTest:function(Re){Re?K(i.DEPTH_TEST):G(i.DEPTH_TEST)},setMask:function(Re){Z!==Re&&!D&&(i.depthMask(Re),Z=Re)},setFunc:function(Re){if(Ae&&(Re=Yg[Re]),oe!==Re){switch(Re){case ta:i.depthFunc(i.NEVER);break;case na:i.depthFunc(i.ALWAYS);break;case ia:i.depthFunc(i.LESS);break;case Oi:i.depthFunc(i.LEQUAL);break;case sa:i.depthFunc(i.EQUAL);break;case ra:i.depthFunc(i.GEQUAL);break;case oa:i.depthFunc(i.GREATER);break;case aa:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}oe=Re}},setLocked:function(Re){D=Re},setClear:function(Re){Ee!==Re&&(i.clearDepth(Re),Ee=Re)},reset:function(){D=!1,Z=null,oe=null,Ee=null}}}function n(){let D=!1,Ae=null,Z=null,oe=null,Ee=null,Re=null,$e=null,St=null,qt=null;return{setTest:function(Qe){D||(Qe?K(i.STENCIL_TEST):G(i.STENCIL_TEST))},setMask:function(Qe){Ae!==Qe&&!D&&(i.stencilMask(Qe),Ae=Qe)},setFunc:function(Qe,Yt,Wn){(Z!==Qe||oe!==Yt||Ee!==Wn)&&(i.stencilFunc(Qe,Yt,Wn),Z=Qe,oe=Yt,Ee=Wn)},setOp:function(Qe,Yt,Wn){(Re!==Qe||$e!==Yt||St!==Wn)&&(i.stencilOp(Qe,Yt,Wn),Re=Qe,$e=Yt,St=Wn)},setLocked:function(Qe){D=Qe},setClear:function(Qe){qt!==Qe&&(i.clearStencil(Qe),qt=Qe)},reset:function(){D=!1,Ae=null,Z=null,oe=null,Ee=null,Re=null,$e=null,St=null,qt=null}}}const s=new e,r=new t,o=new n,a=new WeakMap,c=new WeakMap;let l={},u={},h=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,y=null,x=null,M=null,I=null,b=new Ue(0,0,0),A=0,C=!1,N=null,v=null,w=null,z=null,L=null;const V=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let te=!1,B=0;const $=i.getParameter(i.VERSION);$.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec($)[1]),te=B>=1):$.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),te=B>=2);let Y=null,pe={};const ve=i.getParameter(i.SCISSOR_BOX),F=i.getParameter(i.VIEWPORT),he=new Ze().fromArray(ve),_e=new Ze().fromArray(F);function H(D,Ae,Z,oe){const Ee=new Uint8Array(4),Re=i.createTexture();i.bindTexture(D,Re),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let $e=0;$e<Z;$e++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(Ae,0,i.RGBA,1,1,oe,0,i.RGBA,i.UNSIGNED_BYTE,Ee):i.texImage2D(Ae+$e,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Ee);return Re}const J={};J[i.TEXTURE_2D]=H(i.TEXTURE_2D,i.TEXTURE_2D,1),J[i.TEXTURE_CUBE_MAP]=H(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[i.TEXTURE_2D_ARRAY]=H(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),J[i.TEXTURE_3D]=H(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),K(i.DEPTH_TEST),r.setFunc(Oi),ce(!1),se(Gl),K(i.CULL_FACE),R(Xn);function K(D){l[D]!==!0&&(i.enable(D),l[D]=!0)}function G(D){l[D]!==!1&&(i.disable(D),l[D]=!1)}function ae(D,Ae){return u[D]!==Ae?(i.bindFramebuffer(D,Ae),u[D]=Ae,D===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=Ae),D===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=Ae),!0):!1}function de(D,Ae){let Z=d,oe=!1;if(D){Z=h.get(Ae),Z===void 0&&(Z=[],h.set(Ae,Z));const Ee=D.textures;if(Z.length!==Ee.length||Z[0]!==i.COLOR_ATTACHMENT0){for(let Re=0,$e=Ee.length;Re<$e;Re++)Z[Re]=i.COLOR_ATTACHMENT0+Re;Z.length=Ee.length,oe=!0}}else Z[0]!==i.BACK&&(Z[0]=i.BACK,oe=!0);oe&&i.drawBuffers(Z)}function me(D){return f!==D?(i.useProgram(D),f=D,!0):!1}const xe={[di]:i.FUNC_ADD,[Ef]:i.FUNC_SUBTRACT,[Tf]:i.FUNC_REVERSE_SUBTRACT};xe[Af]=i.MIN,xe[Rf]=i.MAX;const W={[Cf]:i.ZERO,[Pf]:i.ONE,[If]:i.SRC_COLOR,[Qo]:i.SRC_ALPHA,[Ff]:i.SRC_ALPHA_SATURATE,[Uf]:i.DST_COLOR,[Df]:i.DST_ALPHA,[Lf]:i.ONE_MINUS_SRC_COLOR,[ea]:i.ONE_MINUS_SRC_ALPHA,[Of]:i.ONE_MINUS_DST_COLOR,[Nf]:i.ONE_MINUS_DST_ALPHA,[kf]:i.CONSTANT_COLOR,[Bf]:i.ONE_MINUS_CONSTANT_COLOR,[zf]:i.CONSTANT_ALPHA,[Hf]:i.ONE_MINUS_CONSTANT_ALPHA};function R(D,Ae,Z,oe,Ee,Re,$e,St,qt,Qe){if(D===Xn){g===!0&&(G(i.BLEND),g=!1);return}if(g===!1&&(K(i.BLEND),g=!0),D!==bf){if(D!==_||Qe!==C){if((m!==di||x!==di)&&(i.blendEquation(i.FUNC_ADD),m=di,x=di),Qe)switch(D){case Ui:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case vn:i.blendFunc(i.ONE,i.ONE);break;case Xl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ql:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Ui:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case vn:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Xl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ql:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}p=null,y=null,M=null,I=null,b.set(0,0,0),A=0,_=D,C=Qe}return}Ee=Ee||Ae,Re=Re||Z,$e=$e||oe,(Ae!==m||Ee!==x)&&(i.blendEquationSeparate(xe[Ae],xe[Ee]),m=Ae,x=Ee),(Z!==p||oe!==y||Re!==M||$e!==I)&&(i.blendFuncSeparate(W[Z],W[oe],W[Re],W[$e]),p=Z,y=oe,M=Re,I=$e),(St.equals(b)===!1||qt!==A)&&(i.blendColor(St.r,St.g,St.b,qt),b.copy(St),A=qt),_=D,C=!1}function re(D,Ae){D.side===wt?G(i.CULL_FACE):K(i.CULL_FACE);let Z=D.side===Lt;Ae&&(Z=!Z),ce(Z),D.blending===Ui&&D.transparent===!1?R(Xn):R(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),s.setMask(D.colorWrite);const oe=D.stencilWrite;o.setTest(oe),oe&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),ye(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?K(i.SAMPLE_ALPHA_TO_COVERAGE):G(i.SAMPLE_ALPHA_TO_COVERAGE)}function ce(D){N!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),N=D)}function se(D){D!==Sf?(K(i.CULL_FACE),D!==v&&(D===Gl?i.cullFace(i.BACK):D===wf?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):G(i.CULL_FACE),v=D}function le(D){D!==w&&(te&&i.lineWidth(D),w=D)}function ye(D,Ae,Z){D?(K(i.POLYGON_OFFSET_FILL),(z!==Ae||L!==Z)&&(i.polygonOffset(Ae,Z),z=Ae,L=Z)):G(i.POLYGON_OFFSET_FILL)}function j(D){D?K(i.SCISSOR_TEST):G(i.SCISSOR_TEST)}function E(D){D===void 0&&(D=i.TEXTURE0+V-1),Y!==D&&(i.activeTexture(D),Y=D)}function S(D,Ae,Z){Z===void 0&&(Y===null?Z=i.TEXTURE0+V-1:Z=Y);let oe=pe[Z];oe===void 0&&(oe={type:void 0,texture:void 0},pe[Z]=oe),(oe.type!==D||oe.texture!==Ae)&&(Y!==Z&&(i.activeTexture(Z),Y=Z),i.bindTexture(D,Ae||J[D]),oe.type=D,oe.texture=Ae)}function U(){const D=pe[Y];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function Q(){try{i.compressedTexImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ne(){try{i.compressedTexImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ee(){try{i.texSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ce(){try{i.texSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Me(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function be(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ye(){try{i.texStorage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function fe(){try{i.texStorage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function we(){try{i.texImage2D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ke(){try{i.texImage3D.apply(i,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Be(D){he.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),he.copy(D))}function Pe(D){_e.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),_e.copy(D))}function Ke(D,Ae){let Z=c.get(Ae);Z===void 0&&(Z=new WeakMap,c.set(Ae,Z));let oe=Z.get(D);oe===void 0&&(oe=i.getUniformBlockIndex(Ae,D.name),Z.set(D,oe))}function Ge(D,Ae){const oe=c.get(Ae).get(D);a.get(Ae)!==oe&&(i.uniformBlockBinding(Ae,oe,D.__bindingPointIndex),a.set(Ae,oe))}function at(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),l={},Y=null,pe={},u={},h=new WeakMap,d=[],f=null,g=!1,_=null,m=null,p=null,y=null,x=null,M=null,I=null,b=new Ue(0,0,0),A=0,C=!1,N=null,v=null,w=null,z=null,L=null,he.set(0,0,i.canvas.width,i.canvas.height),_e.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:K,disable:G,bindFramebuffer:ae,drawBuffers:de,useProgram:me,setBlending:R,setMaterial:re,setFlipSided:ce,setCullFace:se,setLineWidth:le,setPolygonOffset:ye,setScissorTest:j,activeTexture:E,bindTexture:S,unbindTexture:U,compressedTexImage2D:Q,compressedTexImage3D:ne,texImage2D:we,texImage3D:ke,updateUBOMapping:Ke,uniformBlockBinding:Ge,texStorage2D:Ye,texStorage3D:fe,texSubImage2D:ee,texSubImage3D:Ce,compressedTexSubImage2D:Me,compressedTexSubImage3D:be,scissor:Be,viewport:Pe,reset:at}}function dh(i,e,t,n){const s=jg(n);switch(t){case eu:return i*e;case nu:return i*e;case iu:return i*e*2;case pa:return i*e/s.components*s.byteLength;case ma:return i*e/s.components*s.byteLength;case su:return i*e*2/s.components*s.byteLength;case ga:return i*e*2/s.components*s.byteLength;case tu:return i*e*3/s.components*s.byteLength;case tn:return i*e*4/s.components*s.byteLength;case _a:return i*e*4/s.components*s.byteLength;case br:case Er:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Tr:case Ar:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case va:case Ma:return Math.max(i,16)*Math.max(e,8)/4;case xa:case ya:return Math.max(i,8)*Math.max(e,8)/2;case Sa:case wa:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case ba:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ea:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case Ta:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case Aa:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Ra:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case Ca:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case Pa:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Ia:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case La:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case Da:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Na:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case Ua:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Oa:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Fa:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case ka:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case Rr:case Ba:case za:return Math.ceil(i/4)*Math.ceil(e/4)*16;case ru:case Ha:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Ga:case Va:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function jg(i){switch(i){case Ln:case Jl:return{byteLength:1,components:1};case Is:case Zl:case Ls:return{byteLength:2,components:1};case da:case fa:return{byteLength:2,components:4};case fi:case ha:case ln:return{byteLength:4,components:1};case Ql:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function $g(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new ue,u=new WeakMap;let h;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,S){return f?new OffscreenCanvas(E,S):Fs("canvas")}function _(E,S,U){let Q=1;const ne=j(E);if((ne.width>U||ne.height>U)&&(Q=U/Math.max(ne.width,ne.height)),Q<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const ee=Math.floor(Q*ne.width),Ce=Math.floor(Q*ne.height);h===void 0&&(h=g(ee,Ce));const Me=S?g(ee,Ce):h;return Me.width=ee,Me.height=Ce,Me.getContext("2d").drawImage(E,0,0,ee,Ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+ee+"x"+Ce+")."),Me}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),E;return E}function m(E){return E.generateMipmaps&&E.minFilter!==Gt&&E.minFilter!==Kt}function p(E){i.generateMipmap(E)}function y(E,S,U,Q,ne=!1){if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let ee=S;if(S===i.RED&&(U===i.FLOAT&&(ee=i.R32F),U===i.HALF_FLOAT&&(ee=i.R16F),U===i.UNSIGNED_BYTE&&(ee=i.R8)),S===i.RED_INTEGER&&(U===i.UNSIGNED_BYTE&&(ee=i.R8UI),U===i.UNSIGNED_SHORT&&(ee=i.R16UI),U===i.UNSIGNED_INT&&(ee=i.R32UI),U===i.BYTE&&(ee=i.R8I),U===i.SHORT&&(ee=i.R16I),U===i.INT&&(ee=i.R32I)),S===i.RG&&(U===i.FLOAT&&(ee=i.RG32F),U===i.HALF_FLOAT&&(ee=i.RG16F),U===i.UNSIGNED_BYTE&&(ee=i.RG8)),S===i.RG_INTEGER&&(U===i.UNSIGNED_BYTE&&(ee=i.RG8UI),U===i.UNSIGNED_SHORT&&(ee=i.RG16UI),U===i.UNSIGNED_INT&&(ee=i.RG32UI),U===i.BYTE&&(ee=i.RG8I),U===i.SHORT&&(ee=i.RG16I),U===i.INT&&(ee=i.RG32I)),S===i.RGB_INTEGER&&(U===i.UNSIGNED_BYTE&&(ee=i.RGB8UI),U===i.UNSIGNED_SHORT&&(ee=i.RGB16UI),U===i.UNSIGNED_INT&&(ee=i.RGB32UI),U===i.BYTE&&(ee=i.RGB8I),U===i.SHORT&&(ee=i.RGB16I),U===i.INT&&(ee=i.RGB32I)),S===i.RGBA_INTEGER&&(U===i.UNSIGNED_BYTE&&(ee=i.RGBA8UI),U===i.UNSIGNED_SHORT&&(ee=i.RGBA16UI),U===i.UNSIGNED_INT&&(ee=i.RGBA32UI),U===i.BYTE&&(ee=i.RGBA8I),U===i.SHORT&&(ee=i.RGBA16I),U===i.INT&&(ee=i.RGBA32I)),S===i.RGB&&U===i.UNSIGNED_INT_5_9_9_9_REV&&(ee=i.RGB9_E5),S===i.RGBA){const Ce=ne?Ir:Je.getTransfer(Q);U===i.FLOAT&&(ee=i.RGBA32F),U===i.HALF_FLOAT&&(ee=i.RGBA16F),U===i.UNSIGNED_BYTE&&(ee=Ce===lt?i.SRGB8_ALPHA8:i.RGBA8),U===i.UNSIGNED_SHORT_4_4_4_4&&(ee=i.RGBA4),U===i.UNSIGNED_SHORT_5_5_5_1&&(ee=i.RGB5_A1)}return(ee===i.R16F||ee===i.R32F||ee===i.RG16F||ee===i.RG32F||ee===i.RGBA16F||ee===i.RGBA32F)&&e.get("EXT_color_buffer_float"),ee}function x(E,S){let U;return E?S===null||S===fi||S===Bi?U=i.DEPTH24_STENCIL8:S===ln?U=i.DEPTH32F_STENCIL8:S===Is&&(U=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===fi||S===Bi?U=i.DEPTH_COMPONENT24:S===ln?U=i.DEPTH_COMPONENT32F:S===Is&&(U=i.DEPTH_COMPONENT16),U}function M(E,S){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==Gt&&E.minFilter!==Kt?Math.log2(Math.max(S.width,S.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?S.mipmaps.length:1}function I(E){const S=E.target;S.removeEventListener("dispose",I),A(S),S.isVideoTexture&&u.delete(S)}function b(E){const S=E.target;S.removeEventListener("dispose",b),N(S)}function A(E){const S=n.get(E);if(S.__webglInit===void 0)return;const U=E.source,Q=d.get(U);if(Q){const ne=Q[S.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&C(E),Object.keys(Q).length===0&&d.delete(U)}n.remove(E)}function C(E){const S=n.get(E);i.deleteTexture(S.__webglTexture);const U=E.source,Q=d.get(U);delete Q[S.__cacheKey],o.memory.textures--}function N(E){const S=n.get(E);if(E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(S.__webglFramebuffer[Q]))for(let ne=0;ne<S.__webglFramebuffer[Q].length;ne++)i.deleteFramebuffer(S.__webglFramebuffer[Q][ne]);else i.deleteFramebuffer(S.__webglFramebuffer[Q]);S.__webglDepthbuffer&&i.deleteRenderbuffer(S.__webglDepthbuffer[Q])}else{if(Array.isArray(S.__webglFramebuffer))for(let Q=0;Q<S.__webglFramebuffer.length;Q++)i.deleteFramebuffer(S.__webglFramebuffer[Q]);else i.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&i.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&i.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Q=0;Q<S.__webglColorRenderbuffer.length;Q++)S.__webglColorRenderbuffer[Q]&&i.deleteRenderbuffer(S.__webglColorRenderbuffer[Q]);S.__webglDepthRenderbuffer&&i.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const U=E.textures;for(let Q=0,ne=U.length;Q<ne;Q++){const ee=n.get(U[Q]);ee.__webglTexture&&(i.deleteTexture(ee.__webglTexture),o.memory.textures--),n.remove(U[Q])}n.remove(E)}let v=0;function w(){v=0}function z(){const E=v;return E>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+s.maxTextures),v+=1,E}function L(E){const S=[];return S.push(E.wrapS),S.push(E.wrapT),S.push(E.wrapR||0),S.push(E.magFilter),S.push(E.minFilter),S.push(E.anisotropy),S.push(E.internalFormat),S.push(E.format),S.push(E.type),S.push(E.generateMipmaps),S.push(E.premultiplyAlpha),S.push(E.flipY),S.push(E.unpackAlignment),S.push(E.colorSpace),S.join()}function V(E,S){const U=n.get(E);if(E.isVideoTexture&&le(E),E.isRenderTargetTexture===!1&&E.version>0&&U.__version!==E.version){const Q=E.image;if(Q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{_e(U,E,S);return}}t.bindTexture(i.TEXTURE_2D,U.__webglTexture,i.TEXTURE0+S)}function te(E,S){const U=n.get(E);if(E.version>0&&U.__version!==E.version){_e(U,E,S);return}t.bindTexture(i.TEXTURE_2D_ARRAY,U.__webglTexture,i.TEXTURE0+S)}function B(E,S){const U=n.get(E);if(E.version>0&&U.__version!==E.version){_e(U,E,S);return}t.bindTexture(i.TEXTURE_3D,U.__webglTexture,i.TEXTURE0+S)}function $(E,S){const U=n.get(E);if(E.version>0&&U.__version!==E.version){H(U,E,S);return}t.bindTexture(i.TEXTURE_CUBE_MAP,U.__webglTexture,i.TEXTURE0+S)}const Y={[en]:i.REPEAT,[Yn]:i.CLAMP_TO_EDGE,[Sr]:i.MIRRORED_REPEAT},pe={[Gt]:i.NEAREST,[$l]:i.NEAREST_MIPMAP_NEAREST,[Ps]:i.NEAREST_MIPMAP_LINEAR,[Kt]:i.LINEAR,[wr]:i.LINEAR_MIPMAP_NEAREST,[In]:i.LINEAR_MIPMAP_LINEAR},ve={[rp]:i.NEVER,[hp]:i.ALWAYS,[op]:i.LESS,[cu]:i.LEQUAL,[ap]:i.EQUAL,[up]:i.GEQUAL,[cp]:i.GREATER,[lp]:i.NOTEQUAL};function F(E,S){if(S.type===ln&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===Kt||S.magFilter===wr||S.magFilter===Ps||S.magFilter===In||S.minFilter===Kt||S.minFilter===wr||S.minFilter===Ps||S.minFilter===In)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(E,i.TEXTURE_WRAP_S,Y[S.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,Y[S.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,Y[S.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,pe[S.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,pe[S.minFilter]),S.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,ve[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Gt||S.minFilter!==Ps&&S.minFilter!==In||S.type===ln&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||n.get(S).__currentAnisotropy){const U=e.get("EXT_texture_filter_anisotropic");i.texParameterf(E,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,s.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy}}}function he(E,S){let U=!1;E.__webglInit===void 0&&(E.__webglInit=!0,S.addEventListener("dispose",I));const Q=S.source;let ne=d.get(Q);ne===void 0&&(ne={},d.set(Q,ne));const ee=L(S);if(ee!==E.__cacheKey){ne[ee]===void 0&&(ne[ee]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,U=!0),ne[ee].usedTimes++;const Ce=ne[E.__cacheKey];Ce!==void 0&&(ne[E.__cacheKey].usedTimes--,Ce.usedTimes===0&&C(S)),E.__cacheKey=ee,E.__webglTexture=ne[ee].texture}return U}function _e(E,S,U){let Q=i.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Q=i.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Q=i.TEXTURE_3D);const ne=he(E,S),ee=S.source;t.bindTexture(Q,E.__webglTexture,i.TEXTURE0+U);const Ce=n.get(ee);if(ee.version!==Ce.__version||ne===!0){t.activeTexture(i.TEXTURE0+U);const Me=Je.getPrimaries(Je.workingColorSpace),be=S.colorSpace===Kn?null:Je.getPrimaries(S.colorSpace),Ye=S.colorSpace===Kn||Me===be?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,S.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,S.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ye);let fe=_(S.image,!1,s.maxTextureSize);fe=ye(S,fe);const we=r.convert(S.format,S.colorSpace),ke=r.convert(S.type);let Be=y(S.internalFormat,we,ke,S.colorSpace,S.isVideoTexture);F(Q,S);let Pe;const Ke=S.mipmaps,Ge=S.isVideoTexture!==!0,at=Ce.__version===void 0||ne===!0,D=ee.dataReady,Ae=M(S,fe);if(S.isDepthTexture)Be=x(S.format===Hi,S.type),at&&(Ge?t.texStorage2D(i.TEXTURE_2D,1,Be,fe.width,fe.height):t.texImage2D(i.TEXTURE_2D,0,Be,fe.width,fe.height,0,we,ke,null));else if(S.isDataTexture)if(Ke.length>0){Ge&&at&&t.texStorage2D(i.TEXTURE_2D,Ae,Be,Ke[0].width,Ke[0].height);for(let Z=0,oe=Ke.length;Z<oe;Z++)Pe=Ke[Z],Ge?D&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,Pe.width,Pe.height,we,ke,Pe.data):t.texImage2D(i.TEXTURE_2D,Z,Be,Pe.width,Pe.height,0,we,ke,Pe.data);S.generateMipmaps=!1}else Ge?(at&&t.texStorage2D(i.TEXTURE_2D,Ae,Be,fe.width,fe.height),D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,fe.width,fe.height,we,ke,fe.data)):t.texImage2D(i.TEXTURE_2D,0,Be,fe.width,fe.height,0,we,ke,fe.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ge&&at&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Ae,Be,Ke[0].width,Ke[0].height,fe.depth);for(let Z=0,oe=Ke.length;Z<oe;Z++)if(Pe=Ke[Z],S.format!==tn)if(we!==null)if(Ge){if(D)if(S.layerUpdates.size>0){const Ee=dh(Pe.width,Pe.height,S.format,S.type);for(const Re of S.layerUpdates){const $e=Pe.data.subarray(Re*Ee/Pe.data.BYTES_PER_ELEMENT,(Re+1)*Ee/Pe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,Re,Pe.width,Pe.height,1,we,$e,0,0)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,Pe.width,Pe.height,fe.depth,we,Pe.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Z,Be,Pe.width,Pe.height,fe.depth,0,Pe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?D&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,Pe.width,Pe.height,fe.depth,we,ke,Pe.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Z,Be,Pe.width,Pe.height,fe.depth,0,we,ke,Pe.data)}else{Ge&&at&&t.texStorage2D(i.TEXTURE_2D,Ae,Be,Ke[0].width,Ke[0].height);for(let Z=0,oe=Ke.length;Z<oe;Z++)Pe=Ke[Z],S.format!==tn?we!==null?Ge?D&&t.compressedTexSubImage2D(i.TEXTURE_2D,Z,0,0,Pe.width,Pe.height,we,Pe.data):t.compressedTexImage2D(i.TEXTURE_2D,Z,Be,Pe.width,Pe.height,0,Pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?D&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,Pe.width,Pe.height,we,ke,Pe.data):t.texImage2D(i.TEXTURE_2D,Z,Be,Pe.width,Pe.height,0,we,ke,Pe.data)}else if(S.isDataArrayTexture)if(Ge){if(at&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Ae,Be,fe.width,fe.height,fe.depth),D)if(S.layerUpdates.size>0){const Z=dh(fe.width,fe.height,S.format,S.type);for(const oe of S.layerUpdates){const Ee=fe.data.subarray(oe*Z/fe.data.BYTES_PER_ELEMENT,(oe+1)*Z/fe.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,oe,fe.width,fe.height,1,we,ke,Ee)}S.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,fe.width,fe.height,fe.depth,we,ke,fe.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Be,fe.width,fe.height,fe.depth,0,we,ke,fe.data);else if(S.isData3DTexture)Ge?(at&&t.texStorage3D(i.TEXTURE_3D,Ae,Be,fe.width,fe.height,fe.depth),D&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,fe.width,fe.height,fe.depth,we,ke,fe.data)):t.texImage3D(i.TEXTURE_3D,0,Be,fe.width,fe.height,fe.depth,0,we,ke,fe.data);else if(S.isFramebufferTexture){if(at)if(Ge)t.texStorage2D(i.TEXTURE_2D,Ae,Be,fe.width,fe.height);else{let Z=fe.width,oe=fe.height;for(let Ee=0;Ee<Ae;Ee++)t.texImage2D(i.TEXTURE_2D,Ee,Be,Z,oe,0,we,ke,null),Z>>=1,oe>>=1}}else if(Ke.length>0){if(Ge&&at){const Z=j(Ke[0]);t.texStorage2D(i.TEXTURE_2D,Ae,Be,Z.width,Z.height)}for(let Z=0,oe=Ke.length;Z<oe;Z++)Pe=Ke[Z],Ge?D&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,we,ke,Pe):t.texImage2D(i.TEXTURE_2D,Z,Be,we,ke,Pe);S.generateMipmaps=!1}else if(Ge){if(at){const Z=j(fe);t.texStorage2D(i.TEXTURE_2D,Ae,Be,Z.width,Z.height)}D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,we,ke,fe)}else t.texImage2D(i.TEXTURE_2D,0,Be,we,ke,fe);m(S)&&p(Q),Ce.__version=ee.version,S.onUpdate&&S.onUpdate(S)}E.__version=S.version}function H(E,S,U){if(S.image.length!==6)return;const Q=he(E,S),ne=S.source;t.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+U);const ee=n.get(ne);if(ne.version!==ee.__version||Q===!0){t.activeTexture(i.TEXTURE0+U);const Ce=Je.getPrimaries(Je.workingColorSpace),Me=S.colorSpace===Kn?null:Je.getPrimaries(S.colorSpace),be=S.colorSpace===Kn||Ce===Me?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,S.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,S.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);const Ye=S.isCompressedTexture||S.image[0].isCompressedTexture,fe=S.image[0]&&S.image[0].isDataTexture,we=[];for(let oe=0;oe<6;oe++)!Ye&&!fe?we[oe]=_(S.image[oe],!0,s.maxCubemapSize):we[oe]=fe?S.image[oe].image:S.image[oe],we[oe]=ye(S,we[oe]);const ke=we[0],Be=r.convert(S.format,S.colorSpace),Pe=r.convert(S.type),Ke=y(S.internalFormat,Be,Pe,S.colorSpace),Ge=S.isVideoTexture!==!0,at=ee.__version===void 0||Q===!0,D=ne.dataReady;let Ae=M(S,ke);F(i.TEXTURE_CUBE_MAP,S);let Z;if(Ye){Ge&&at&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Ae,Ke,ke.width,ke.height);for(let oe=0;oe<6;oe++){Z=we[oe].mipmaps;for(let Ee=0;Ee<Z.length;Ee++){const Re=Z[Ee];S.format!==tn?Be!==null?Ge?D&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee,0,0,Re.width,Re.height,Be,Re.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee,Ke,Re.width,Re.height,0,Re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ge?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee,0,0,Re.width,Re.height,Be,Pe,Re.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee,Ke,Re.width,Re.height,0,Be,Pe,Re.data)}}}else{if(Z=S.mipmaps,Ge&&at){Z.length>0&&Ae++;const oe=j(we[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,Ae,Ke,oe.width,oe.height)}for(let oe=0;oe<6;oe++)if(fe){Ge?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,we[oe].width,we[oe].height,Be,Pe,we[oe].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Ke,we[oe].width,we[oe].height,0,Be,Pe,we[oe].data);for(let Ee=0;Ee<Z.length;Ee++){const $e=Z[Ee].image[oe].image;Ge?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee+1,0,0,$e.width,$e.height,Be,Pe,$e.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee+1,Ke,$e.width,$e.height,0,Be,Pe,$e.data)}}else{Ge?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,0,0,Be,Pe,we[oe]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0,Ke,Be,Pe,we[oe]);for(let Ee=0;Ee<Z.length;Ee++){const Re=Z[Ee];Ge?D&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee+1,0,0,Be,Pe,Re.image[oe]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,Ee+1,Ke,Be,Pe,Re.image[oe])}}}m(S)&&p(i.TEXTURE_CUBE_MAP),ee.__version=ne.version,S.onUpdate&&S.onUpdate(S)}E.__version=S.version}function J(E,S,U,Q,ne,ee){const Ce=r.convert(U.format,U.colorSpace),Me=r.convert(U.type),be=y(U.internalFormat,Ce,Me,U.colorSpace);if(!n.get(S).__hasExternalTextures){const fe=Math.max(1,S.width>>ee),we=Math.max(1,S.height>>ee);ne===i.TEXTURE_3D||ne===i.TEXTURE_2D_ARRAY?t.texImage3D(ne,ee,be,fe,we,S.depth,0,Ce,Me,null):t.texImage2D(ne,ee,be,fe,we,0,Ce,Me,null)}t.bindFramebuffer(i.FRAMEBUFFER,E),se(S)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Q,ne,n.get(U).__webglTexture,0,ce(S)):(ne===i.TEXTURE_2D||ne>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Q,ne,n.get(U).__webglTexture,ee),t.bindFramebuffer(i.FRAMEBUFFER,null)}function K(E,S,U){if(i.bindRenderbuffer(i.RENDERBUFFER,E),S.depthBuffer){const Q=S.depthTexture,ne=Q&&Q.isDepthTexture?Q.type:null,ee=x(S.stencilBuffer,ne),Ce=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Me=ce(S);se(S)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Me,ee,S.width,S.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,Me,ee,S.width,S.height):i.renderbufferStorage(i.RENDERBUFFER,ee,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ce,i.RENDERBUFFER,E)}else{const Q=S.textures;for(let ne=0;ne<Q.length;ne++){const ee=Q[ne],Ce=r.convert(ee.format,ee.colorSpace),Me=r.convert(ee.type),be=y(ee.internalFormat,Ce,Me,ee.colorSpace),Ye=ce(S);U&&se(S)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ye,be,S.width,S.height):se(S)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ye,be,S.width,S.height):i.renderbufferStorage(i.RENDERBUFFER,be,S.width,S.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function G(E,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,E),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(S.depthTexture).__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),V(S.depthTexture,0);const Q=n.get(S.depthTexture).__webglTexture,ne=ce(S);if(S.depthTexture.format===zi)se(S)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Q,0,ne):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Q,0);else if(S.depthTexture.format===Hi)se(S)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Q,0,ne):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Q,0);else throw new Error("Unknown depthTexture format")}function ae(E){const S=n.get(E),U=E.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==E.depthTexture){const Q=E.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),Q){const ne=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,Q.removeEventListener("dispose",ne)};Q.addEventListener("dispose",ne),S.__depthDisposeCallback=ne}S.__boundDepthTexture=Q}if(E.depthTexture&&!S.__autoAllocateDepthBuffer){if(U)throw new Error("target.depthTexture not supported in Cube render targets");G(S.__webglFramebuffer,E)}else if(U){S.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer[Q]),S.__webglDepthbuffer[Q]===void 0)S.__webglDepthbuffer[Q]=i.createRenderbuffer(),K(S.__webglDepthbuffer[Q],E,!1);else{const ne=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ee=S.__webglDepthbuffer[Q];i.bindRenderbuffer(i.RENDERBUFFER,ee),i.framebufferRenderbuffer(i.FRAMEBUFFER,ne,i.RENDERBUFFER,ee)}}else if(t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=i.createRenderbuffer(),K(S.__webglDepthbuffer,E,!1);else{const Q=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=S.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ne)}t.bindFramebuffer(i.FRAMEBUFFER,null)}function de(E,S,U){const Q=n.get(E);S!==void 0&&J(Q.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),U!==void 0&&ae(E)}function me(E){const S=E.texture,U=n.get(E),Q=n.get(S);E.addEventListener("dispose",b);const ne=E.textures,ee=E.isWebGLCubeRenderTarget===!0,Ce=ne.length>1;if(Ce||(Q.__webglTexture===void 0&&(Q.__webglTexture=i.createTexture()),Q.__version=S.version,o.memory.textures++),ee){U.__webglFramebuffer=[];for(let Me=0;Me<6;Me++)if(S.mipmaps&&S.mipmaps.length>0){U.__webglFramebuffer[Me]=[];for(let be=0;be<S.mipmaps.length;be++)U.__webglFramebuffer[Me][be]=i.createFramebuffer()}else U.__webglFramebuffer[Me]=i.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){U.__webglFramebuffer=[];for(let Me=0;Me<S.mipmaps.length;Me++)U.__webglFramebuffer[Me]=i.createFramebuffer()}else U.__webglFramebuffer=i.createFramebuffer();if(Ce)for(let Me=0,be=ne.length;Me<be;Me++){const Ye=n.get(ne[Me]);Ye.__webglTexture===void 0&&(Ye.__webglTexture=i.createTexture(),o.memory.textures++)}if(E.samples>0&&se(E)===!1){U.__webglMultisampledFramebuffer=i.createFramebuffer(),U.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let Me=0;Me<ne.length;Me++){const be=ne[Me];U.__webglColorRenderbuffer[Me]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,U.__webglColorRenderbuffer[Me]);const Ye=r.convert(be.format,be.colorSpace),fe=r.convert(be.type),we=y(be.internalFormat,Ye,fe,be.colorSpace,E.isXRRenderTarget===!0),ke=ce(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,ke,we,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Me,i.RENDERBUFFER,U.__webglColorRenderbuffer[Me])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(U.__webglDepthRenderbuffer=i.createRenderbuffer(),K(U.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ee){t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),F(i.TEXTURE_CUBE_MAP,S);for(let Me=0;Me<6;Me++)if(S.mipmaps&&S.mipmaps.length>0)for(let be=0;be<S.mipmaps.length;be++)J(U.__webglFramebuffer[Me][be],E,S,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Me,be);else J(U.__webglFramebuffer[Me],E,S,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0);m(S)&&p(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ce){for(let Me=0,be=ne.length;Me<be;Me++){const Ye=ne[Me],fe=n.get(Ye);t.bindTexture(i.TEXTURE_2D,fe.__webglTexture),F(i.TEXTURE_2D,Ye),J(U.__webglFramebuffer,E,Ye,i.COLOR_ATTACHMENT0+Me,i.TEXTURE_2D,0),m(Ye)&&p(i.TEXTURE_2D)}t.unbindTexture()}else{let Me=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(Me=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Me,Q.__webglTexture),F(Me,S),S.mipmaps&&S.mipmaps.length>0)for(let be=0;be<S.mipmaps.length;be++)J(U.__webglFramebuffer[be],E,S,i.COLOR_ATTACHMENT0,Me,be);else J(U.__webglFramebuffer,E,S,i.COLOR_ATTACHMENT0,Me,0);m(S)&&p(Me),t.unbindTexture()}E.depthBuffer&&ae(E)}function xe(E){const S=E.textures;for(let U=0,Q=S.length;U<Q;U++){const ne=S[U];if(m(ne)){const ee=E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Ce=n.get(ne).__webglTexture;t.bindTexture(ee,Ce),p(ee),t.unbindTexture()}}}const W=[],R=[];function re(E){if(E.samples>0){if(se(E)===!1){const S=E.textures,U=E.width,Q=E.height;let ne=i.COLOR_BUFFER_BIT;const ee=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ce=n.get(E),Me=S.length>1;if(Me)for(let be=0;be<S.length;be++)t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let be=0;be<S.length;be++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(ne|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(ne|=i.STENCIL_BUFFER_BIT)),Me){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ce.__webglColorRenderbuffer[be]);const Ye=n.get(S[be]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ye,0)}i.blitFramebuffer(0,0,U,Q,0,0,U,Q,ne,i.NEAREST),c===!0&&(W.length=0,R.length=0,W.push(i.COLOR_ATTACHMENT0+be),E.depthBuffer&&E.resolveDepthBuffer===!1&&(W.push(ee),R.push(ee),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,R)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,W))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Me)for(let be=0;be<S.length;be++){t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,Ce.__webglColorRenderbuffer[be]);const Ye=n.get(S[be]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,Ye,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const S=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[S])}}}function ce(E){return Math.min(s.maxSamples,E.samples)}function se(E){const S=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function le(E){const S=o.render.frame;u.get(E)!==S&&(u.set(E,S),E.update())}function ye(E,S){const U=E.colorSpace,Q=E.format,ne=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||U!==Dt&&U!==Kn&&(Je.getTransfer(U)===lt?(Q!==tn||ne!==Ln)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",U)),S}function j(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=z,this.resetTextureUnits=w,this.setTexture2D=V,this.setTexture2DArray=te,this.setTexture3D=B,this.setTextureCube=$,this.rebindTextures=de,this.setupRenderTarget=me,this.updateRenderTargetMipmap=xe,this.updateMultisampleRenderTarget=re,this.setupDepthRenderbuffer=ae,this.setupFrameBufferTexture=J,this.useMultisampledRTT=se}function Jg(i,e){function t(n,s=Kn){let r;const o=Je.getTransfer(s);if(n===Ln)return i.UNSIGNED_BYTE;if(n===da)return i.UNSIGNED_SHORT_4_4_4_4;if(n===fa)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ql)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Jl)return i.BYTE;if(n===Zl)return i.SHORT;if(n===Is)return i.UNSIGNED_SHORT;if(n===ha)return i.INT;if(n===fi)return i.UNSIGNED_INT;if(n===ln)return i.FLOAT;if(n===Ls)return i.HALF_FLOAT;if(n===eu)return i.ALPHA;if(n===tu)return i.RGB;if(n===tn)return i.RGBA;if(n===nu)return i.LUMINANCE;if(n===iu)return i.LUMINANCE_ALPHA;if(n===zi)return i.DEPTH_COMPONENT;if(n===Hi)return i.DEPTH_STENCIL;if(n===pa)return i.RED;if(n===ma)return i.RED_INTEGER;if(n===su)return i.RG;if(n===ga)return i.RG_INTEGER;if(n===_a)return i.RGBA_INTEGER;if(n===br||n===Er||n===Tr||n===Ar)if(o===lt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===br)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Er)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Tr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ar)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===br)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Er)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Tr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ar)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===xa||n===va||n===ya||n===Ma)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===xa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===va)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ya)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ma)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Sa||n===wa||n===ba)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Sa||n===wa)return o===lt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===ba)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ea||n===Ta||n===Aa||n===Ra||n===Ca||n===Pa||n===Ia||n===La||n===Da||n===Na||n===Ua||n===Oa||n===Fa||n===ka)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ea)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ta)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Aa)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ra)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ca)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Pa)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ia)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===La)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Da)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Na)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ua)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Oa)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Fa)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ka)return o===lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Rr||n===Ba||n===za)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Rr)return o===lt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ba)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===za)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ru||n===Ha||n===Ga||n===Va)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Rr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Ha)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ga)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Va)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Bi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class Zg extends At{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class pt extends ut{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Qg={type:"move"};class Rc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new pt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new pt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new P,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new P),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new pt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new P,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new P),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,n),p=this._getHandJoint(l,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],d=u.position.distanceTo(h.position),f=.02,g=.005;l.inputState.pinching&&d>f+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=f-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Qg)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new pt;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const e_=`
void main() {
